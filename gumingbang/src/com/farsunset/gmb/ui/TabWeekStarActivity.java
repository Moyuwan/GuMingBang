...
import com.farsunset.gmb.fragment.FctReportFragment;
...
public class TabWeekStarActivity extends BaseFragmentActivity implements OnClickListener,OnRefreshListener{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_weekstar);
	...
	void initViews()
	{
		...
		webImageView = new WebImageView(this);
		webImageView.setBackgroundResource(R.drawable.home_wall);
		webImageView.setId(R.id.bannerView);
		webImageView.setOnClickListener(this);
		((LinearLayout)listView.getHeader().findViewById(R.id.bannerView)).addView(webImageView);
		
		payProductFragment = (PayProductFragment) TabWeekStarActivity.this.getSupportFragmentManager().findFragmentById(R.id.payProductFragment);
		//reportFragment = (FctReportFragment) WeekStarActivity.this.getSupportFragmentManager().findFragmentById(R.id.reportFragment);
		TabWeekStarActivity.this.getSupportFragmentManager().beginTransaction().hide(payProductFragment).commit();
		...
		listView.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int index,
				...
				TabWeekStarActivity.this.getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.slide_in_left,R.anim.slide_out_right).show(payProductFragment).commit();
