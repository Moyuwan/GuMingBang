...
public class KeywordsFlow extends FrameLayout implements OnGlobalLayoutListener,OnClickListener {
    ...
    private OnKeywordClickListener itemClickListener; 
    ...
    private void init() {  
        ...
        random = new Random();  
        vecKeywords = new Vector<String>(length);  
            ...
            for (int i = 0; i < size; i++) {  
              ...
              //  int txtSize = TEXT_SIZE_MIN + random.nextInt(TEXT_SIZE_MAX - TEXT_SIZE_MIN + 1);  
                ...
                txt.setOnClickListener(new OnClickListener() {
					...
					@Override
					public void onClick(View v) {
						itemClickListener.onKeywordClick(((TextView)v).getText().toString().trim());
    ...
    public  void feedKeywordsFlow( String[] arr) {  
        length = arr.length;
        for (int i = 0; i <length; i++) {  
            this.feedKeyword( arr[i]);  
        }  
    }
